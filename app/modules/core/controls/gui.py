...
#
# Created: Mon Jul 13 14:23:17 2015
...
class Ui_projectionsControls(object):
    def setupUi(self, projectionsControls):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 647, 138))
        ...
        self.cmdOpenImageDirectory = QtGui.QToolButton(self.dockWidgetContents)
        self.cmdOpenImageDirectory.setText(_fromUtf8(""))
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/main/icons/directory.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cmdOpenImageDirectory.setIcon(icon4)
        self.cmdOpenImageDirectory.setIconSize(QtCore.QSize(20, 20))
        self.cmdOpenImageDirectory.setObjectName(_fromUtf8("cmdOpenImageDirectory"))
        self.horizontalLayout_7.addWidget(self.cmdOpenImageDirectory)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 649, 275))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/main/icons/undo-32.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cmdPreviousHistory.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/main/icons/redo-32.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cmdNextHistory.setIcon(icon6)
    ...
    def retranslateUi(self, projectionsControls):
        projectionsControls.setWindowTitle(_translate("projectionsControls", "Projection Controls", None))
        ...
        self.cmdOpenImageDirectory.setToolTip(_translate("projectionsControls", "Open Image directory", None))
